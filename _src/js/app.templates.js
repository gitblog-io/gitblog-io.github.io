angular.module("gitblog.templates", []).run([
  "$templateCache", function($templateCache) {
    // $templateCache.put("templates/blog-list.html", "<li ng-repeat=\"repo in repos track by repo.name\">\n  <a ng-href=\"#!/{{repo.fullName}}\">\n    <img ng-src=\"{{repo.owner.avatar().url}}s=140\" class=\"avatar\">\n    {{repo.owner.login}}\n  </a>\n</li>");
    $templateCache.put("templates/post.html", "<article post ng-model=\"post\"></article>");
